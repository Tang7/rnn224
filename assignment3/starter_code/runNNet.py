...
from rnn2deep_withDROP import RNN2_drop
from rnn import RNN
...
def run(args=None):
    ...
    # for RNN_drop
    parser.add_option("--dropoutFraction",dest="dropoutFraction",type="float",default=0.5)
    ...
    elif(opts.model=='RNN2_drop'):
        nn = RNN2_drop(opts.wvecDim,opts.middleDim,opts.outputDim,opts.numWords,opts.dropoutFraction,opts.minibatch)
    ...
    if evaluate_accuracy_while_training:
        ...
        plt.legend()
        plt.savefig("train_dev_acc_%s.png"%(opts.model))
